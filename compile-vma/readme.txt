...
2) Download VMA source code from https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator. 
   Then copy the vk_mem_alloc.h file to this folder.

3) Open the vk_mem_alloc.h file and uncomment the following two lines (line 1819 in v2.3.0):
...
4) Start "compile win-x64.bat" or "compile win-x86.bat". 
   This will crate the vk_mem_alloc.dll in the same folder.



Additional info:

To compile the vma, we have added the vk_mem_alloc.cpp. Its content is set to:
...
Used cl.exe compiler command line options:
